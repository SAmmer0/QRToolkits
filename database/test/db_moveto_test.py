...
print(db.move_to('num_test', 'num_dest', (DataClassification.STRUCTURED, DataValueCategory.NUMERIC, DataFormatCategory.PANEL)))
print(db.move_to('char_test', 'char_dest', (DataClassification.STRUCTURED, DataValueCategory.CHAR, DataFormatCategory.PANEL)))
